...
// }
 ...
 public void read_Table_17 (char department, int nurses) {
     
 }
 
 /*    private String inputFile;
    private ArrayList <Integer> Need1A = new ArrayList <Integer> ();
    private ArrayList <Integer> Need2A = new ArrayList <Integer> ();
            ...
            for (int i = 0; i < sheet.getRows(); i++) {
                for (int j = 0; j < sheet.getColumns(); j++) {
                    ...
                    if (cell.getContents()== "")
                    {
                        ...
                        if (i == 6 && j> 1) 
                        {
                        Need1A.add(Integer.parseInt(cell.getContents()));
                        }
                    }

                }
            }
            for (Integer integer : Need1A) {
